        ...
        >
          <div className="relative">
            ...
            >
              ...
              {/* Admin Panel Link (subtle) */}
              <Link
                to="/purple"
                className="md:ml-4 inline-flex items-center px-4 py-2 text-sm font-medium rounded-md text-slate-500 dark:text-slate-400 hover:text-indigo-600 dark:hover:text-indigo-400 transition-colors group"
              >
                <Lock className="mr-1 h-4 w-4 opacity-50 group-hover:opacity-100 transition-opacity" />
